...
<body>
    <div class="max-w-5xl max-md:max-w-xl mx-auto bg-white py-4">
        <h1 class="mt-[20px] text-3xl font-bold text-gray-800 text-center border-b-[3px] border-gray-800 pb-1">
            Summary
        </h1>
        ...
        <div class="grid md:grid-cols-3 gap-8 mt-16">
            ...
            <div class="bg-gray-100 rounded-md p-4 h-max">
                ...
                <div class="mt-6 space-y-3">
                    <button type="button"
                        class="text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-teal-600 hover:bg-teal-700 text-white rounded-md">Checkout</button>
                    <button type="button"
                        class="text-sm px-4 py-2.5 w-full font-semibold tracking-wide bg-transparent hover:bg-white text-gray-800 border border-gray-300 rounded-md">
                        Cancel
                    </button>
                </div>
            </div>
